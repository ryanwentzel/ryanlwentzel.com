...
You are gracious and merciful, slow to anger and abounding in steadfast love. You are good to all, and your mercy is over all you have made. 
...
Lord, by your design, we are all so different from each other.
Personalities, experiences, backgrounds. Would you help us to be patient and forbearing with each other, gentle, self-controlled, and reasonable? Make us eager to overlook minor faults, and quick to forgive when we’re sinned against.
